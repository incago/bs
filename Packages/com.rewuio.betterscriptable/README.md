# BetterScriptable Package

This package contains the reusable BetterScriptable runtime and editor tooling.
...
- `Tools > BetterScriptable > Generator`: creates ScriptableObject data classes and their paired creation menu.
- `Tools > BetterScriptable > Open`: opens the spreadsheet-style editor for selected `.betterscriptable` documents.
...
- `*.betterscriptable`: BetterScriptable authoring source document, including serialized data and sheet metadata.
