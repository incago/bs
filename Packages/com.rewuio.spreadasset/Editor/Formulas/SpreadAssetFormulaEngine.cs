...
{
    internal static class SpreadAssetFormulaEngine
    {
        public static bool TryParseTarget(string formula, out SpreadAssetCellAddress target)
        {
            target = default;
        ...
        public static bool TryCollectTargetCells(
            ...
            int rowCount,
            out List<SpreadAssetCellAddress> targets)
        {
            targets = new List<SpreadAssetCellAddress>();
            ...
            if (target.IsColumn)
            {
                ...
                {
                    targets.Add(new SpreadAssetCellAddress(row, target.Column));
                }
        ...
        public static bool TryApply(
            ...
            IReadOnlyList<string> columnPropertyNames,
            IReadOnlyList<SpreadAssetFormulaState> formulas,
            out string error)
        {
        ...
        public static bool TryApply(
            ...
            IReadOnlyList<string> columnPropertyNames,
            IReadOnlyList<SpreadAssetFormulaState> formulas,
            ISpreadAssetFormulaCellStore cellStore,
            out string error)
        {
            ...
            out string error)
        {
            ...
            {
                SpreadAssetFormulaState formula = formulas[i];
                ...
                if (target.IsColumn)
                {
                    ...
                    for (int row = 0; row < rowCount; row++)
                    {
                        targetKeys.Add(GetTargetKey(new SpreadAssetCellAddress(row, target.Column)));
                    }
            ...
            out string error)
        {
            ...
            foreach (ParsedFormula formula in compiledFormulas.Formulas)
            {
                if (formula.Target.IsColumn)
                {
                    ...
                    {
                        SpreadAssetCellAddress cell = new SpreadAssetCellAddress(row, formula.Target.Column);
        ...
        public static bool TryParseCellAddress(string text, out SpreadAssetCellAddress address)
        {
            address = default;
            ...
            address = new SpreadAssetCellAddress(row - 1, column - 1);
            return true;
        }
        ...
        {
            target = default;
            if (TryParseCellAddress(targetText, out SpreadAssetCellAddress cellAddress))
            {
        ...
        private static bool IsCellInRange(int rowCount, int columnCount, SpreadAssetCellAddress address)
        {
        ...
        private static string GetTargetKey(SpreadAssetCellAddress address)
        {
        ...
        public sealed class CompiledFormulaSet
        {
            ...
            internal bool IsSpecificCellTarget(SpreadAssetCellAddress address)
            {
        ...
        internal readonly struct FormulaTarget
        {
            ...
            public readonly SpreadAssetCellAddress Cell;
            public readonly int Column;

            private FormulaTarget(bool isColumn, SpreadAssetCellAddress cell, int column)
            {
                IsColumn = isColumn;
                Cell = cell;
                Column = column;
            ...
            public static FormulaTarget ForCell(SpreadAssetCellAddress cell)
            {
        ...
        internal sealed class ColumnLookup
        {
            ...
            public ColumnLookup(IReadOnlyList<string> columnPropertyNames)
            {
                ...
                for (int i = 0; i < columnPropertyNames.Count; i++)
                {
                    ...
                    AddName(SpreadAssetNameUtility.ToPascalCase(propertyName?.TrimStart('_') ?? string.Empty), i);
                }
            }
        ...
        private sealed class FormulaParser
        {
            ...
            private readonly ColumnLookup _columnLookup;
            private readonly ISpreadAssetFormulaCellStore _cellStore;
            ...
            private bool TryParseFactor(out FormulaValue value, out string error)
            {
                ...
                if (TryReadReference(out SpreadAssetCellAddress address))
                {
            ...
            private bool TryReadReference(out SpreadAssetCellAddress address)
            {
                address = default;
                SkipWhitespace();
                int start = _position;
                ...
                {
                    address = new SpreadAssetCellAddress(_currentRow, column);
                    return true;
                }
    ...
    internal readonly struct SpreadAssetCellAddress
    {
        public readonly int Row;
        public readonly int Column;

        public SpreadAssetCellAddress(int row, int column)
        {
            Row = row;
            Column = column;
        }
    ...
    internal interface ISpreadAssetFormulaCellStore
    {
